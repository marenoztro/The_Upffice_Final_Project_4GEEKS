...
export const DetailView = () => {
  ...
  //   }, [])
  {
    store.detailedSpaces.map((item, i) => {
      return (
        <>
          ...
          <div>
            <ul className="list-group list-group-flush">
              <li className="list-group-item">
                <h3>Ubicación</h3> {item.name} Lorem ipsum dolor sit amet,
                consectetur adipisicing elit. Ab, commodi magni quibusdam
                possimus porro, tempore ratione voluptatem rem aliquam nam fuga
                facere atque in iusto quod excepturi. Ad, excepturi molestiae.
              </li>
              <li className="list-group-item">
                <h3>Precio: $100</h3>
              </li>
              <li className="list-group-item">
                ...
                doloremque quas nihil dolore ad deserunt nisi dolores corrupti
                enim officiis laborum sequi tempora, quia odit!
              </li>
              <li className="list-group-item">
                <h3>Amenidades</h3>
                <ul>
                ...
                <ul>
                  <li>
                    ...
                    nulla accusantium quidem praesentium ab eveniet excepturi
                    harum qui sunt.
                  </li>
                </ul>
              </li>
              <li className="list-group-item">
                <h3>Reviews</h3> Lorem ipsum dolor sit, amet consectetur
                adipisicing elit. Libero saepe iste debitis error ratione quis
                soluta. Voluptate eos aliquam dicta recusandae quidem
                necessitatibus animi cupiditate quae quas! Neque, omnis eaque!
              </li>
